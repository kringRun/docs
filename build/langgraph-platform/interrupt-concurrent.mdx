...
<Tabs>
    ...
    from langchain.messages import convert_to_messages
...
<Callout icon="pen-to-square" iconType="regular">
  [Edit the source of this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/langgraph-platform/interrupt-concurrent.mdx)
</Callout>

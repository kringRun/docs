...
Now that you've added custom middleware to your deployment, you can use similar techniques to add [custom routes](/langgraph-platform/custom-routes) or define [custom lifespan events](/langgraph-platform/custom-lifespan) to further customize your server's behavior.

---

<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/langgraph-platform/custom-middleware.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/langgraph-platform/custom-middleware.mdx">

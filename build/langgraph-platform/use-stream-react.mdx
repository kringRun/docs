...
Learn more about interrupts in the [How to handle interrupts](/oss/python/langgraph/add-human-in-the-loop#pause-using-interrupt) guide.
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/langgraph-platform/use-stream-react.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/langgraph-platform/use-stream-react.mdx">

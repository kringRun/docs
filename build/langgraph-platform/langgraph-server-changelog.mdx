...
- Reverted the renaming of user-visible elements from "studio" back to "debugger".
...
- Renamed user-visible elements from Studio to Debugger for improved clarity and consistency.
...
<Callout icon="pen-to-square" iconType="regular">
  [Edit the source of this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/langgraph-platform/langgraph-server-changelog.mdx)
</Callout>

...
<div class="mx-auto max-w-8xl px-0 lg:px-5" style={{ paddingBottom: "8rem" }}>
    <div class="mdx-content prose prose-gray dark:prose-invert mx-4 pt-10">
        <h1 class="flex whitespace-pre-wrap group font-semibold text-2xl sm:text-3xl mt-8">The agent engineering platform</h1>
        ...
        <h2 class="flex whitespace-pre-wrap group font-semibold">Open source frameworks</h2>

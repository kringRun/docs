...
* If you are using the LangSmith SDK's with other model providers, you should carefully read through [this guide](/langsmith/log-llm-trace#manually-provide-usage-information).
...
See [this guide](/langsmith/log-llm-trace#manually-provide-usage-information) to learn how to manually provide cost information for a run.

---

<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/langsmith/calculate-token-based-costs.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/langsmith/calculate-token-based-costs.mdx">

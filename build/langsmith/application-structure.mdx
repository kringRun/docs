...
This page describes the typical structure of an application and shows how the required information to deploy an application using LangSmith is specified.
...
If you're working with a deployed LangGraph application locally, you can configure environment variables in the `env` key of the [configuration file](#configuration-file-concepts).

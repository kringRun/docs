...
Now that we have defined all of our tools, we can use [`create_agent`](https://langchain-ai.github.io/langchain/reference/langchain/agents/create_agent.html)/[`createAgent`](https://langchain-ai.github.io/langgraphjs/reference/functions/langchain_agents.createAgent.html) to create our agent.
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/langsmith/test-react-agent-pytest.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/langsmith/test-react-agent-pytest.mdx">

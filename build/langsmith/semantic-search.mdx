...
* A deployment (refer to [how to set up an application for deployment](/langsmith/setup-app-requirements-txt)) and details on [platform deployment types](/langsmith/deployments).

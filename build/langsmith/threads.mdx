...
- [Add metadata and tags to traces](./add-metadata-tags)
...
You can [add metadata to your traces](./add-metadata-tags) in LangSmith in a variety of ways, this code will show how to do so dynamically, but read the
...
![Thread Tab](/langsmith/images/convo-tab.png)
...
![Conversation](/langsmith/images/convo.png)
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/langsmith/threads.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/langsmith/threads.mdx">

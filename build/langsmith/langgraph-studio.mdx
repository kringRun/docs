...
<Frame caption="LangSmith Platform Components with agent/graph deployment">
  <img src="/langsmith/images/platform-outline.svg" alt="The LangGraph CLI creates a LangGraph Server instance. Studio can interact with LangGraph Server. RemoteGraph and the SDKs can also interact with the LangGraph Server deployment(s)." />
</Frame>

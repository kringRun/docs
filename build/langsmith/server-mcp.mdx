...
You can set up [custom authentication middleware](/langsmith/custom-auth) to authenticate a user with an MCP server to get access to user-scoped tools within your LangSmith Platform deployment.
...
* Upgrade to use langgraph-api>=0.2.3. If you are deploying LangSmith Platform, this will be done for you automatically if you create a new revision.
...
To make user-scoped tools available to your LangSmith Platform deployment, start with implementing a snippet like the following:

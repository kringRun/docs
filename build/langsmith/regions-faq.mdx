...
<Note>
See the [cloud architecture reference](/langsmith/cloud-architecture-and-scalability#architecture) for additional details.
</Note>
...
See the [cloud architecture reference](/langsmith/cloud-architecture-and-scalability#architecture) for details.
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/langsmith/regions-faq.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/langsmith/regions-faq.mdx">

...
To add a tool to your prompt, click the `+ Tool` button at the bottom of the prompt editor. ![](/langsmith/images/add-tool.png)
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/langsmith/use-tools.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/langsmith/use-tools.mdx">

...
3. Understanding how to make your agent configurable, as detailed in the [Configuration](/labs/oap/custom-agents/configuration) section
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/labs/oap/custom-agents/overview.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/labs/oap/custom-agents/overview.mdx">

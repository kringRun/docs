...
This guide explains the mechanics of using [subgraphs](/oss/python/langgraph/use-subgraphs). A subgraph is a [graph](/oss/python/langgraph/graph-api#graphs) that is used as a [node](/oss/python/langgraph/graph-api#nodes) in another graph.

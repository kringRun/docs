---
title: LangChain V1
description: Learn about the new features, improvements, and migration steps in LangChain V1, as well as how to migrate from LangChain V0 to V1.
---
...
### 1. Build agents with `create_agent`
...
<Note>
The old `config["configurable"]` pattern still works for backward compatibility, but using the new `context` parameter is recommended for new code.
</Note>

...
<CardGroup cols={1}>
    ...
    <Card title="LangChain Classic" icon="arrows-turn-right" href="#langchain-classic" arrow>
        Legacy functionality has moved to [`langchain-classic`](https://pypi.org/project/langchain-classic) to keep the core package focused on the most important agent building blocks.
    </Card>
</CardGroup>
...
flowchart TD
    ...
    wrap_tool_call["wrap_tool_call<br/>(tools)"]
    wrap_model_call["wrap_model_call<br/>(model)"]
    after_model["after_model"]
    after_agent["after_agent"]
    result["result"]

    request --> before_agent --> before_model
...
LangChain v1 focuses on standard interfaces and production-ready agents.

Legacy functionality has moved to [`langchain-classic`](https://pypi.org/project/langchain-classic) to keep the core package lean.

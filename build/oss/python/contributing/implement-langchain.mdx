...
<Tabs>
    <Tab title="Chat Models">
        ...
        See the [chat model integration guide](/oss/python/langchain/models) for details on implementing a chat model integration.
    </Tab>
    <Tab title="Tools">
        ...
        See the [tool integration guide](/oss/python/langchain/tools) for details on implementing a tool integration.
    </Tab>
    <Tab title="Retrievers">
        ...
        See the [retriever integration guide](/oss/python/integrations/retrievers) for details on implementing a retriever integration.
    </Tab>
    ...
    <Tab title="Embeddings">
        ...
        See the [embedding model integration guide](/oss/python/integrations/text_embedding) for details on implementing an embedding model integration.
    </Tab>
</Tabs>

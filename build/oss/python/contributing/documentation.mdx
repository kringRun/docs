...
<AccordionGroup>
    ...
    <Accordion title="Examples">
        <Columns cols={3}>
            <Card title="Memory" href="/oss/python/concepts/memory" />
            <Card title="Context" href="/oss/python/concepts/context" />
            <Card title="Subgraphs" href="/oss/python/concepts/subgraphs" />
        </Columns>
    </Accordion>
</AccordionGroup>

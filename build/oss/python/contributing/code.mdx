    ...
    <Tab title="LangChain" icon="link">
        <AccordionGroup>
            ...
            <Accordion title="Partner packages">
                For changes to [partner integrations](/oss/python/integrations/providers):
    ...
    <Tab title="LangChain" icon="link">
        ...
        <AccordionGroup>
            ...
            <Accordion title="Partner packages">
                ...
                Many partner packages are in external repositories. Please check the [list of integrations](/oss/python/integrations/providers) for details.
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/oss/contributing/code.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/oss/contributing/code.mdx">

...
This guide provides a quick overview for getting started with the (MODULE_NAME) [vector store](/oss/python/integrations/vectorstores#overview). For a detailed listing of all (MODULE_NAME)VectorStore features, paramaters, and configurations, head to the [(MODULE_NAME)VectorStore API reference](<LINK>).
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/oss/python/integrations/vectorstores/TEMPLATE.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/vectorstores/TEMPLATE.mdx">

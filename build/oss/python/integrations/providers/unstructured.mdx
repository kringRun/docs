...
See a [usage example](/oss/python/integrations/document_loaders/csv#unstructuredcsvloader).
...
See a [usage example](/oss/python/integrations/document_loaders/email).
...
See a [usage example](/oss/python/integrations/document_loaders/epub).
...
See a [usage example](/oss/python/integrations/document_loaders/google_drive#passing-in-optional-file-loaders).
...
See a [usage example](/oss/python/integrations/document_loaders/image).
...
See a [usage example](/oss/python/integrations/document_loaders/odt).
...
See a [usage example](/oss/python/integrations/document_loaders/org_mode).
...
See a [usage example](/oss/python/integrations/document_loaders/rst).
...
See a [usage example](/oss/python/integrations/document_loaders/tsv).
...
See a [usage example](/oss/python/integrations/document_loaders/url).
...
See a [usage example](/oss/python/integrations/document_loaders/microsoft_word#using-unstructured).
...
See a [usage example](/oss/python/integrations/document_loaders/xml).
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/oss/python/integrations/providers/unstructured.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/providers/unstructured.mdx">

...
See a [usage example](/oss/python/integrations/llms/edenai).
...
See a [usage example](/oss/python/integrations/chat/edenai).
...
See a [usage example](/oss/python/integrations/text_embedding/edenai).
...
See a [usage example](/oss/python/integrations/tools/edenai_tools).
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/oss/python/integrations/providers/edenai.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/providers/edenai.mdx">

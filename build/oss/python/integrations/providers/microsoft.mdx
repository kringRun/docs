...
See a [usage example](/oss/python/integrations/text_embedding/azureopenai)
...
See a [usage example for the Azure Blob Storage](/oss/python/integrations/document_loaders/azure_blob_storage_container).

```python
from langchain_community.document_loaders import AzureBlobStorageContainerLoader
```

See a [usage example for the Azure Files](/oss/python/integrations/document_loaders/azure_blob_storage_file).
...
See [detail configuration instructions](/oss/python/integrations/vectorstores/azure_cosmos_db).
...
See a [usage example](/oss/python/integrations/vectorstores/azure_cosmos_db).
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/oss/python/integrations/providers/microsoft.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/providers/microsoft.mdx">

...
For more information, see [this notebook](/oss/python/integrations/chat/tencent_hunyuan)
...
For more information, see [this notebook](/oss/python/integrations/document_loaders/tencent_cos_directory)
...
For more information, see [this notebook](/oss/python/integrations/document_loaders/tencent_cos_file)
...
For more information, see [this notebook](/oss/python/integrations/vectorstores/tencentvectordb)
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/oss/python/integrations/providers/tencent.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/providers/tencent.mdx">

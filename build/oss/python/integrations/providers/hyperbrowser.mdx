...
You can see more details [here](/oss/python/integrations/tools/hyperbrowser_browser_agent_tools)
...
Here is a brief description of the Web Scraping Tools available with Hyperbrowser. You can see more details [here](/oss/python/integrations/tools/hyperbrowser_web_scraping_tools)
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/oss/python/integrations/providers/hyperbrowser.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/providers/hyperbrowser.mdx">

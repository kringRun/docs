...
See a [usage example running model on Intel CPU](/oss/python/integrations/text_embedding/ipex_llm).
See a [usage example running model on Intel GPU](/oss/python/integrations/text_embedding/ipex_llm_gpu).
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/oss/python/integrations/providers/baai.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/providers/baai.mdx">

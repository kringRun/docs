...
You can also find Zep Open Source compatible [Retriever](/oss/python/integrations/retrievers/zep_memorystore), and [Vector Store](/oss/python/integrations/vectorstores/zep) examples.
...
See a [usage example](/oss/python/integrations/retrievers/zep_cloud_memorystore).
...
See a [usage example](/oss/python/integrations/vectorstores/zep_cloud).

---

<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/oss/python/integrations/providers/zep.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/providers/zep.mdx">

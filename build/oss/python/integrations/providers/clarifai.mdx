...
For more details, the docs on the Clarifai LLM wrapper provide a [detailed walkthrough](/oss/python/integrations/llms/clarifai).
...
```
For more details, the docs on the Clarifai vector store provide a [detailed walkthrough](/oss/python/integrations/vectorstores/clarifai).

---

<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/oss/python/integrations/providers/clarifai.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/providers/clarifai.mdx">

...
See a [usage example](/oss/python/integrations/text_embedding/optimum_intel).
We also offer a full tutorial notebook [`rag_with_quantized_embeddings.ipynb`](https://github.com/langchain-ai/langchain/blob/v0.3/cookbook/rag_with_quantized_embeddings.ipynb) for using the embedder in a RAG pipeline.
...
See a [usage example](/oss/python/integrations/text_embedding/itrex).
...
See a [usage example](/oss/python/integrations/llms/weight_only_quantization).
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/oss/python/integrations/providers/intel.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/providers/intel.mdx">

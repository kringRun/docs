...
[retriever](/oss/python/langchain/retrieval/) that combines **unstructured** similarity search
...
<Tabs groupId="vector-store" queryString>
    ...
    <Tab title="Apache Cassandra">
      ...
      [Apache Cassandra Vector Store Guide](/oss/python/integrations/vectorstores/cassandra#connection-parameters)
    ...
    <Tab title="OpenSearch">
      ...
      [OpenSearch Vector Store Guide](/oss/python/integrations/vectorstores/opensearch).
        </div>
    </Tab>
    <Tab title="Chroma">
        <div style={{ paddingLeft: '30px' }}>
      ...
      [Chroma Vector Store Guide](/oss/python/integrations/vectorstores/chroma).
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/oss/python/integrations/retrievers/graph_rag.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/retrievers/graph_rag.mdx">

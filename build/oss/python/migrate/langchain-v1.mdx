...
Dynamic prompts are a core context engineering pattern—adapting what you tell the model based on the current conversation state. The `@dynamic_prompt` decorator makes this simple:

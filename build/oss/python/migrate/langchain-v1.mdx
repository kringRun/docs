...
LangChain v1 introduces convenient import paths for commonly used abstractions. While the old `langchain_core` import paths continue to work, we recommend using the new paths for better ergonomics.

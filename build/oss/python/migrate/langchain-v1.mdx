...
Existing functionality outside the focus of standard interfaces and agents has been moved to the [`langchain-classic`](https://pypi.org/project/langchain-classic) package. Install [`langchain-classic`](https://pypi.org/project/langchain-classic) and update imports from `langchain` to [`langchain-classic`](https://pypi.org/project/langchain-classic).

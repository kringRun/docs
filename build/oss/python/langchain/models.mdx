...
The easiest way to get started with a model in LangChain is to use `init_chat_model` to initialize one from a [provider](/oss/python/integrations/providers) of your choice (examples below):
...
<Info>
    To find all the parameters supported by a given chat model, head to the [reference docs](https://python.langchain.com/api_reference/).
</Info>
...
<AccordionGroup>
    <Accordion title="Tool execution loop" icon="arrow-rotate-right">
        ...
        LangChain includes [agent](/oss/python/langchain/agents) abstractions that handle this orchestration for you. Below, we illustrate a simple example:
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/oss/langchain/models.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/oss/langchain/models.mdx">

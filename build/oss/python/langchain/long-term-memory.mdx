...
def get_user_info() -> str:
    ...
    store = get_runtime().store # [!code highlight]
...
def save_user_info(user_info: UserInfo, config: RunnableConfig) -> str:
    """Save user info."""
    # Access the store - same as that provided to `create_agent`
    store = get_store() # [!code highlight]
...
agent.invoke(
    ...
    config={"configurable": {"user_id": "user_123"}} # [!code highlight]
)
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/oss/langchain/long-term-memory.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/oss/langchain/long-term-memory.mdx">

...
from langchain.messages import AIMessage, MessageLikeRepresentation
...
list of [Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html) objects.

...
You can use [`prompt` parameter](/oss/python/langchain/agents#prompt) to pass in a function that returns a string to use as system prompt
...
You can use [`prompt` parameter](/oss/python/langchain/agents#prompt) to pass in a function that returns a list of messages
...
You can use [`prompt` parameter](/oss/python/langchain/agents#prompt) to pass in a function that returns a list of messages or a custom system prompt.
...
You can use [`prompt` parameter](/oss/python/langchain/agents#prompt) to pass in a function that returns a list of messages or a custom system prompt.
Session context is passed in with the [`state` parameter](/oss/python/langchain/short-term-memory#prompt)
...
You can use [pre_model_hook](/oss/python/langchain/agents#pre-model-hook) to update state
...
You can pass in a [function to `model` parameter](/oss/python/langchain/agents#dynamic-model) that attaches custom tools
...
You can pass in a [function to `model` parameter](/oss/python/langchain/agents#dynamic-model) that returns a custom model
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/oss/langchain/context-engineering.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/oss/langchain/context-engineering.mdx">

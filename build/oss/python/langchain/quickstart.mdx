...
<Steps>
    ...
    <Step title="Create tools">
        ...
        <Tip>
            ...
            We've defined them here as plain Python functions, but LangChain's [@tool decorator](https://python.langchain.com/api_reference/core/tools/langchain_core.tools.convert.tool.html) decorator is often used to add extra metadata.
        </Tip>
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/oss/langchain/quickstart.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/oss/langchain/quickstart.mdx">

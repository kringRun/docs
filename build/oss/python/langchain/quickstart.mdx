...
<Steps>
    ...
    <Step title="Create tools">
        ...
        <Tip>
            ...
            We've defined them here as plain Python functions, but LangChain's [@tool decorator](https://python.langchain.com/api_reference/core/tools/langchain_core.tools.base.tool.html#langchain_core.tools.convert.tool.html) decorator is often used to add extra metadata.
        </Tip>

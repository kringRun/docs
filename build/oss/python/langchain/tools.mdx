...
<Note>
    We recommend that you familiarize yourself with `create_agent()` before covering this section. [Read more about agents](/oss/python/langchain/agents).
</Note>
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/oss/langchain/tools.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/oss/langchain/tools.mdx">

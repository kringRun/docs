                ...
                "decisions": [
                    {
                        ...
                        "edited_action": {
                            ...
                            "arguments": {"key1": "new_value", "key2": "original_value"},
                        }
                    }
                ]
            }
...
3. If any calls require human input, the middleware builds a `HITLRequest` with `action_requests` and `review_configs` and calls [interrupt](https://langchain-ai.github.io/langgraph/reference/types/#langgraph.types.interrupt).

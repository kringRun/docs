...
Agent Chat UI can connect to both [local](/oss/javascript/langgraph/debugger#setup-local-langgraph-server) and [deployed agents](/oss/javascript/langgraph/deploy).

...
This guide explains the mechanics of using [subgraphs](/oss/javascript/langgraph/use-subgraphs). A subgraph is a [graph](/oss/javascript/langgraph/graph-api#graphs) that is used as a [node](/oss/javascript/langgraph/graph-api#nodes) in another graph.

...
<Tabs>
    <Tab title="Chat Models">
        ...
        See the [chat model integration guide](/oss/javascript/langchain/models) for details on implementing a chat model integration.
    </Tab>
    <Tab title="Tools">
        ...
        See the [tool integration guide](/oss/javascript/langchain/tools) for details on implementing a tool integration.
    </Tab>
    <Tab title="Retrievers">
        ...
        See the [retriever integration guide](/oss/javascript/integrations/retrievers) for details on implementing a retriever integration.
    </Tab>
    ...
    <Tab title="Embeddings">
        ...
        See the [embedding model integration guide](/oss/javascript/integrations/text_embedding) for details on implementing an embedding model integration.
    </Tab>
</Tabs>
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/oss/contributing/implement-langchain.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/oss/contributing/implement-langchain.mdx">

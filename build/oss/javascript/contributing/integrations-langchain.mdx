...
<Steps>
    ...
    <Step title="Pass standard tests">
        If applicable, implement the [standard tests](/oss/javascript/contributing/standard-tests-langchain) for your integration and successfully run them.
    </Step>
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/oss/contributing/integrations-langchain.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/oss/contributing/integrations-langchain.mdx">

...
<Card title="Custom RAG Agent" icon="user-magnifying-glass" href="/oss/javascript/langgraph/agentic-rag">
  Build a RAG agent using LangGraph primitives for fine-grained control.
</Card>

<Card title="Custom SQL Agent" icon="database" href="/oss/javascript/langgraph/sql-agent">
...
<Card title="Context engineering" icon="book-open" href="/oss/javascript/concepts/context">
  Learn methods for providing AI applications the right information and tools to accomplish a task.
</Card>

<Card title="Graph API" icon="chart-network" href="/oss/javascript/langgraph/graph-api">
  Explore LangGraph’s declarative graph-building API.
</Card>

<Card title="Functional API" icon="code" href="/oss/javascript/langgraph/functional-api">
...
<Card title="Case Studies" icon="screen-users" href="/oss/javascript/langgraph/case-studies">

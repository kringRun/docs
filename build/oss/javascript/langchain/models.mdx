...
<Note>
This guide has been updated for LangChain v1. If you're upgrading from v0, see the [migration guide](/oss/javascript/python/migrate/langchain-v1) for breaking changes and migration patterns.
</Note>

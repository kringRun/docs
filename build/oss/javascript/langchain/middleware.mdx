...
<Note>
**Important:** Human-in-the-loop middleware requires a [checkpointer](/oss/javascript/python/langgraph/checkpointing) to maintain state across interruptions.

See the [human-in-the-loop documentation](/oss/javascript/python/langchain/human-in-the-loop) for complete examples and integration patterns.
</Note>
...
<Accordion title="Built-in PII types and strategies">

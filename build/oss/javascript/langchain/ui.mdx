...
Agent Chat UI can connect to both [local](/oss/javascript/langchain/studio#setup-local-langgraph-server) and [deployed agents](/oss/javascript/langchain/deploy).
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/oss/langchain/ui.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/oss/langchain/ui.mdx">

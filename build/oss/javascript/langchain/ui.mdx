...
Agent Chat UI can connect to both [local](/oss/javascript/langchain/debugger#setup-local-langgraph-server) and [deployed agents](/oss/javascript/langchain/deploy).

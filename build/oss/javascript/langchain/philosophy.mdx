...
<Update label="2024-06">
    ...
    Integrations were split out of the core LangChain package, and either into their own standalone packages (for the core integrations) or `langchain-community`.
</Update>

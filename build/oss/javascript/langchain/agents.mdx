...
<Info>
This documentation covers LangChain v1. If you're upgrading from v0, see the [v1 migration guide](/oss/javascript/python/migrate/langchain-v1) for changes to agent APIs.
</Info>
...
Pass a list of tools to the agent. The agent will create a [`ToolNode`](https://reference.langchain.com/javascript/classes/langchain.index.ToolNode.html) under the hood to execute them:

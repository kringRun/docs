...
<Note>
This guide uses LangChain v1 syntax. If you're using v0, see the [migration guide](/oss/javascript/python/migrate/langchain-v1) to update your code.
</Note>
...
<Note>
    We recommend that you familiarize yourself with `createAgent()` before covering this section. [Read more about agents](/oss/javascript/langchain/agents).
</Note>

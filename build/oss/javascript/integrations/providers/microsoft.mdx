...
import IntegrationAzureOpenai from "/snippets/javascript-integrations/examples/models/chat/integration_azure_openai.mdx";

<IntegrationAzureOpenai />
...
import AzureOpenai from "/snippets/javascript-integrations/examples/models/llm/azure_openai.mdx";
...
import AzureOpenaiEmbeddings from "/snippets/javascript-integrations/examples/models/embeddings/azure_openai_embeddings.mdx";
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/oss/javascript/integrations/providers/microsoft.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/providers/microsoft.mdx">

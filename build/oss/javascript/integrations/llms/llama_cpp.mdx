...
import LlamaCpp from "/snippets/javascript-integrations/examples/models/llm/llama_cpp.mdx";

<LlamaCpp />

## Streaming

import LlamaCppStream from "/snippets/javascript-integrations/examples/models/llm/llama_cpp_stream.mdx";
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/oss/javascript/integrations/llms/llama_cpp.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/llms/llama_cpp.mdx">

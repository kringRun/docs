...
import Connery from "/snippets/javascript-integrations/examples/tools/connery.mdx";
...
check out the [Connery Toolkit](/oss/javascript/integrations/tools/connery_toolkit) documentation.
</Note>
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/oss/javascript/integrations/tools/connery.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/tools/connery.mdx">

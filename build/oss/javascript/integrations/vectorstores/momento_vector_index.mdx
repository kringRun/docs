...
import Fromtexts from "/snippets/javascript-integrations/examples/indexes/vector_stores/momento_vector_index/fromTexts.mdx";
...
import Fromdocs from "/snippets/javascript-integrations/examples/indexes/vector_stores/momento_vector_index/fromDocs.mdx";

<Fromdocs />

### Search from an existing collection

import Fromexisting from "/snippets/javascript-integrations/examples/indexes/vector_stores/momento_vector_index/fromExisting.mdx";
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/oss/javascript/integrations/vectorstores/momento_vector_index.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/vectorstores/momento_vector_index.mdx">

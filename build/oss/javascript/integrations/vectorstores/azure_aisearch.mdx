...
import EnvVars from "/snippets/javascript-integrations/examples/indexes/vector_stores/azure_aisearch/env_vars.mdx";
...
import AzureAisearch from "/snippets/javascript-integrations/examples/indexes/vector_stores/azure_aisearch/azure_aisearch.mdx";
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/oss/javascript/integrations/vectorstores/azure_aisearch.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/vectorstores/azure_aisearch.mdx">

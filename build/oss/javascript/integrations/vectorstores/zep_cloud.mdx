...
import ZepCloud from "/snippets/javascript-integrations/examples/indexes/vector_stores/zep/zep_cloud.mdx";

<ZepCloud />

### Example: Using ZepCloudVectorStore with Expression Language

import ZepCloudVectorStore from "/snippets/javascript-integrations/examples/guides/expression_language/zep/zep_cloud_vector_store.mdx";
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/oss/javascript/integrations/vectorstores/zep_cloud.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/vectorstores/zep_cloud.mdx">

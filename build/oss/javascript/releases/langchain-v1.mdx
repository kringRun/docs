...
The [React-style agent](/oss/javascript/langchain/agents) is now part of the core `langchain` project. Import directly from `langchain`:
...
<CardGroup cols={2}>
  <Card title="View Source" icon="eye" href="https://github.com/langchain-ai/docs/blob/main/src/oss/javascript/releases/langchain-v1.mdx">
    See the source of this page on GitHub
  </Card>
  <Card title="Edit Source" icon="pen-to-square" href="https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/releases/langchain-v1.mdx">

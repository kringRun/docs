...
This guide explains the mechanics of using [subgraphs](/oss/langgraph/use-subgraphs). A subgraph is a [graph](/oss/langgraph/graph-api#graphs) that is used as a [node](/oss/langgraph/graph-api#nodes) in another graph.

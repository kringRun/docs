...
<CodeGroup>
    ...
    ```bash bun
    bun add langchain @langchain/anthropic
    ```
</CodeGroup>
:::
...
<Steps>
    ...
    <Step title="Create tools">
        ...
        Tools can depend on [runtime context](/oss/langchain/runtime) and also interact with [agent memory](/oss/langchain/memory).

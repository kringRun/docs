...
:::python
ToolNode is a prebuilt LangChain component that handles tool calls within an agent's workflow. It works seamlessly with `create_agent()`, offering advanced tool execution control, built in parallelism, and error handling.
:::

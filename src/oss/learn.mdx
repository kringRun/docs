...
<Card title="Semantic Search" icon="magnifying-glass" href="/oss/langchain/knowledge-base" horizontal>
...
<Card title="SQL Agent" icon="database" href="/oss/langchain/sql-agent" horizontal>
  Build a SQL agent that can interact with databases with human-in-the-loop review.
</Card>
...
<Card title="Custom RAG Agent" icon="user-magnifying-glass" href="/oss/langgraph/agentic-rag">
  Build a RAG agent using LangGraph primitives for fine-grained control.
</Card>

<Card title="Custom SQL Agent" icon="database" href="/oss/langgraph/sql-agent">
...
<Card title="Memory" icon="brain" href="/oss/concepts/memory">
  Understand persistence of interactions within and across threads.
</Card>

<Card title="Context engineering" icon="book-open" href="/oss/concepts/context">
  Learn methods for providing AI applications the right information and tools to accomplish a task.
</Card>

<Card title="Graph API" icon="chart-network" href="/oss/langgraph/graph-api">
  Explore LangGraph’s declarative graph-building API.
</Card>

<Card title="Functional API" icon="code" href="/oss/langgraph/functional-api">
...
<Card title="Case Studies" icon="screen-users" href="/oss/langgraph/case-studies">

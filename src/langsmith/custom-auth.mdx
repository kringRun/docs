...
---
This guide shows how to add custom authentication to your LangSmith application. This guide applies to both cloud and self-hosted deployments. It does not apply to isolated usage of the LangGraph open source library in your own custom server.
